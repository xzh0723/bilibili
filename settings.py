...
HEADERS = {
    'Origine': 'https://www.bilibili.com',
    'Referer': 'https://www.bilibili.com/ranking/all/1/0/3',
...
ITEM_PIPELINES = {
    'bilibili.pipelines.TextPipeline': 300,
    #'bilibili.pipelines.DownloadPipeline': 301,
    'bilibili.pipelines.MongoPipeline': 302
}
...
TYPE = [0, 1, 168, 3, 129, 4, 36, 188, 160, 119, 155, 5, 181]
